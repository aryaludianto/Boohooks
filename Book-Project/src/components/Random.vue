...
//Applying randomWords generator
...
export default Vue.extend({
  ...
  created() {
    ...
    //will run randomizer function and fetch data with keyword generated by radomWords generator
  ...
  methods: {
    ...
    randomizer() {
      //assign this.keyword with randomized word generated by randomWords generator ( 1 word)
      this.keyword = randomWords(1)[0];
    },
    randomBtn() {
      //Random Button will run randomizer function and fetch data with keyword generated by radomWords generator
      this.randomizer();
      this.fetchData();
    }
  },
