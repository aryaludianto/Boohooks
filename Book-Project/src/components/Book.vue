      ...
      <div class="container">
        ...
        <div class="books-container">
          <div id="list-th" v-for="(book, index ) in books" :key="index">
            <div class="book read">
              <div class="cover">
                <img :src="book.volumeInfo.imageLinks ? book.volumeInfo.imageLinks.thumbnail : noCoverUrl " />
              </div>
